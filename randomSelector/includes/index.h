...
constexpr int HISTORY_INDEX = 11;
constexpr int NO_LINE = -1;
constexpr int RESULT_SHOW_LINE_IN_MAIN_MENU = 3;
constexpr int HISTORY_LINE_IN_MAIN_MENU = 4;
constexpr int SETTING_LINE_IN_MAIN_MENU = 5;
constexpr int WEIGHT_SELECT_IN_SETTING = 3;
constexpr int ITEM_SETUP_IN_SETTING = 5;
constexpr int ITEM_LIST_SETTING_IN_SETTING = 6;
